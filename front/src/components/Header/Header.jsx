        ...
        <header className={styles.header} id="header">
            <nav className="navbar navbar-expand-lg bg-body-tertiary h-100 p-0 navbar-custom">
                <div className="container">
                    <Link to="/" className={`navbar-brand ${styles.logo}`}><img src={Bosom} alt="Bosom" /></Link>
                    ...
                    <div className="collapse navbar-collapse d-lg-flex justify-content-lg-between"
                        ...
                        <ul className="navbar-nav ms-2 mb-2 mb-lg-0 w-100 justify-content-center">
                            <li className="nav-item">
                                <Link to="/" className="menu_link" aria-current="page">Главная</Link>
                            </li>
                            <li className="nav-item dropdown">
                                <div className="menu_link dropdown-toggle" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    Общество
                                </div>
                                <ul className="dropdown-menu">
                                    <li><Link to="/" className="dropdown-item">Устав</Link></li>
                                    <li><Link to="/" className="dropdown-item">Структура</Link></li>
                                    <li><Link to="/" className="dropdown-item">Нормативные документы</Link></li>
                                    <li><Link to="/" className="dropdown-item">Компании-партнеры</Link></li>
                                    <li><Link to="/signup" className="dropdown-item">Вступить в общество</Link></li>
                                    <li><Link to="/" className="dropdown-item">Оплатить взносы</Link></li>
                                    <li><Link to="/" className="dropdown-item">Фотогалерея</Link></li>
                                </ul>
                            </li>
                            <li className="nav-item dropdown">
                                <div className="menu_link dropdown-toggle" role="button" data-bs-toggle="dropdown"
                                ...
                                <ul className="dropdown-menu">
                                    <li><Link to="/" className="dropdown-item">Центры</Link></li>
                                    <li><Link to="/" className="dropdown-item">Курсы</Link></li>
                                    <li><Link to="/" className="dropdown-item">Учебные материалы</Link></li>
                                </ul>
                            </li>
                            <li className="nav-item">
                            ...
                            <li>
                                ...
                                <button className={`btn ${styles.headerSearchBtnHandler}`} onClick={getSearchVisible}
                                    type="button">
                                    <svg version="1.1" width="36px" height="36px" viewBox="0 0 122.879 119.799">
                        ...
                        <div className={`nav-item ms-2 mb-2 ${styles.headerAccountIcon}`}>
                            <Link to="/login" className="nav-link" aria-current="page">
                                {authed ? <svg height="36px" width="36px" version="1.1" viewBox="0 0 60.671 60.671">
                                    <g>
                                    ...
                                    : <svg height="36px" width="36px" viewBox="0 0 1024 1024" version="1.1">
                ...
                <form className={isSearchVisible ? 'd-flex ms-2 mb-2' : 'd-none'} role="search">
                    <input className={`me-2 ${styles.headerSearchInput}`} type="search" placeholder="Поиск"
                        aria-label="Search" />
                    <button className={`btn ${styles.headerSearchBtn}`} type="submit">
