		...
		<header className={styles.header} id="header">
			<nav className="navbar navbar-expand-lg h-100 navbar-custom">
				<div className="container p-lg-0">
					...
					>
						<span className={!expanded ? 'navbar-toggler-icon' : 'btn-close'} data-testid="nav-btn">
						...
						<ul className="navbar-nav me-auto ms-lg-2 mb-2 mb-lg-0 w-100 justify-content-center">
							...
							<li className="nav-item dropdown">
								...
								<ul className="dropdown-menu dropdown-menu-right">
									...
									<li>
										<Link to={routes.STRUCTURE.link} className="dropdown-item" onClick={hideMenu}>
											Структура
										</Link>
									</li>
									<li>
									...
									<li>
										<Link to={routes.PARTNERS.link} className="dropdown-item" onClick={hideMenu}>
											Компании-партнеры
										</Link>
									</li>
									<li>
									...
									<li>
										<Link to="/payments" className="dropdown-item" onClick={hideMenu}>
											Оплатить взносы
										</Link>
									</li>
									<li>
							...
							<li>
								<button
									className={`btn ${styles.headerSearchBtnHandler}`}
									onClick={getSearchVisible}
									type="button"
								>
									<svg
										version="1.1"
				...
				<form
					className={isSearchVisible ? 'd-flex ms-2 mb-2' : 'd-none'}
					role="search"
				>
					<input
						className={`me-2 ${styles.headerSearchInput}`}
						type="search"
						placeholder="Поиск"
						aria-label="Search"
					/>
